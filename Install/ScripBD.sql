...
INSERT INTO menu (id_menu,descripcion,tipo, nivel, url_sistema)  values (s_menu.nextVal, 'Cortes Pendientes', 0,'90.6','/views/cortesPendientes.xhtml');
...
INSERT INTO menu (id_menu,descripcion,tipo, nivel, url_sistema)  values (s_menu.nextVal, 'Depósitos Bancarios', 0,'90.10','/depositosBancarios/.xhtml');
...
INSERT INTO TIPOS_OPERACION(ID_TIPO_OPERACION_PK,NOMBRE,DESCRIPCION) VALUES (1,'PAGO DE SERVICIOS','MULTIPLES SERVICIOS');
INSERT INTO TIPOS_OPERACION(ID_TIPO_OPERACION_PK,NOMBRE,DESCRIPCION) VALUES (2,'TRANSFERENCIA','SE MANDA DINERO A OTRA CAJA');
INSERT INTO TIPOS_OPERACION(ID_TIPO_OPERACION_PK,NOMBRE,DESCRIPCION) VALUES (3,'PAGO A PROVEDORES ','PAGOS A PROVEDORES');
...
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,1,'PAGO DE LUZ','PAGO DE LUZ');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,1,'PAGO DE RENTA','PAGO DE RENTA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,1,'PAGO DE AGUA ','PAGO DE AGUA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,1,'PAGO DE GAS ','PAGO DE GAS');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,2,'TRANSFERENCIA ','SE MANDA O RECIBE DINERO A OTRA CAJA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,3,'PAGO A PROVEDORES ','PAGO A PROVEDORES');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,4,'REGISTRAR ABONO DE CREDITO','ABONO DE CREDITO');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,5,'PAGO DE VENTAS MENUDEO','PAGO DE VENTAS MENUDEO');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,6,'PAGO DE VENTAS MAYOREO','PAGO DE VENTAS MAYOREO');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,7,'DEPOSITOS BANCARIOS ','DEPOSITO BANCARIO DE ESTA CAJA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (S_CONCEPTOS.nextVal,8,'AJUSTE EN CAJA','AJUSTE EN CAJA');
