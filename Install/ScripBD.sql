...
CONSTRAINT C_PB_ID_TRANS_BANCARIAS_PK PRIMARY KEY (ID_TRANS_BANCARIAS_PK),
CONSTRAINT C_PB_ID_CAJA_FK FOREIGN KEY (ID_CAJA_FK) REFERENCES CAJA(ID_CAJA_PK),
CONSTRAINT C_PB_ID_CONCEPTO_FK FOREIGN KEY (ID_CONCEPTO_FK) REFERENCES CONCEPTOS (ID_CONCEPTOS_PK),
CONSTRAINT C_PB_ID_USER_FK FOREIGN KEY (ID_CONCEPTO_FK) REFERENCES USUARIO(ID_USUARIO_PK),
CONSTRAINT C_PB_ID_CUENTA_FK FOREIGN KEY (ID_CUENTA_FK) REFERENCES CUENTA_BANCARIA(ID_CUENTA_BANCARIA_PK)
);
d
