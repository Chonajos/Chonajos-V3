...
INSERT INTO menu (id_menu,descripcion,tipo, nivel, url_sistema)  values (s_menu.nextVal, 'Entrega de Mercancia', 0,'90.4','/views/entregaMercancia.xhtml');
...
CREATE TABLE CONCEPTOS_ENTRADA_SALIDA(
ID_CONCEPTO_PK NUMBER,
NOMBRE VARCHAR(100),
...
CONSTRAINT C_ES_ID_CONCEPTO_FK FOREIGN KEY (ID_CONCEPTO_FK) REFERENCES CONCEPTOS_ENTRADA_SALIDA(ID_CONCEPTO_PK)
);
