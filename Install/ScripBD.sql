...
CONSTRAINT C_DC_ID_ABONO_FK FOREIGN KEY(ID_ABONO_FK) references ABONO_CREDITO(ID_ABONO_CREDITO_PK),
CONSTRAINT C_DC_ID_CLIENTE_FK FOREIGN KEY(ID_CLIENTE_FK) references CLIENTE(ID_CLIENTE),
CONSTRAINT C_DC_ID_STATUS_FK FOREIGN KEY(ID_STATUS_FK) references STATUS(ID_PK)
); 
