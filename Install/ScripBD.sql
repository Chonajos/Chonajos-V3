...
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (1,1,'PAGO DE LUZ','PAGO DE LUZ');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (2,1,'PAGO DE RENTA','PAGO DE RENTA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (3,1,'PAGO DE AGUA ','PAGO DE AGUA');
INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (4,1,'PAGO DE GAS ','PAGO DE GAS');

INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (5,2,'TRANSFERENCIA SEGURA','TRANSFERENCIA');

INSERT INTO CONCEPTOS(ID_CONCEPTOS_PK,ID_TIPO_OPERACION_FK,NOMBRE,DESCRIPCION) VALUES (6,3,'PAGO ADELANTADO DE PROVEDOR','PROVEDORES');
...
MONTO NUMBER,
CONSTRAINT C_ES_ID_ENTRADA_SALIDA_PK PRIMARY KEY (ID_ENTRADA_SALIDA_PK),
CONSTRAINT C_ES_ID_CAJA_FK FOREIGN KEY (ID_CAJA_FK) REFERENCES CAJA(ID_CAJA_PK),
CONSTRAINT C_ES_ID_CONCEPTO_FK FOREIGN KEY (ID_CONCEPTO_FK) REFERENCES CONCEPTOS(ID_CONCEPTOS_PK)
);

CREATE SEQUENCE S_ENTRADA_SALIDA
INCREMENT BY 1
START WITH 1
MINVALUE 0;
...
ID_CAJA_FK NUMBER,
FECHA DATE,
VENTAS_MAYOREO NUMBER,
VENTAS_MENUDEO NUMBER,
ABONOS_CREDITOS DATE,
ANTICIPOS NUMBER,
CANT_CHEQUES NUMBER,
MONTO_CHEQUES NUMBER,
