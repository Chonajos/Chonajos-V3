...
public final class CFDv33Factory {
    ...
    public static Comprobante createComprobante() throws Exception {
        ...
        comp.setSerie("A");
        comp.setFolio("11639");
        Date date = new GregorianCalendar(2017, 01, 23, 14, 15, 12).getTime();
        comp.setFecha(date);
        comp.setFormaPago("01");
        comp.setSubTotal(new BigDecimal("3410.000000"));
        comp.setDescuento(new BigDecimal("0.000000"));
        comp.setTotal(new BigDecimal("3410.000000"));
        ...
        comp.setNoCertificado("00001000000404327545");
...
//    comp.setAddenda(createAddenda(of));
    ...
    private static Conceptos createConceptos(ObjectFactory of) {
        ...
        c1.setImporte(new BigDecimal("3410.000000"));
