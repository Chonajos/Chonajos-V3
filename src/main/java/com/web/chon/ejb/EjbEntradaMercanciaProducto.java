...
public class EjbEntradaMercanciaProducto implements NegocioEntradaMercanciaProducto {
    ...
    public List<Object[]> getEntradaProductoByIdEM(BigDecimal idEntradaProducto) {
        ...
        System.out.println("idEntradaProducto "+idEntradaProducto);
        Query query = em.createNativeQuery("SELECT EMP.ID_EMP_PK,EMP.ID_EM_FK,EMP.ID_SUBPRODUCTO_FK,EMP.ID_TIPO_EMPAQUE_FK, "
                ...
                + ", (SELECT COUNT(EXPR.ID_EXP_PK) FROM EXISTENCIA_PRODUCTO EXPR WHERE EXPR.ID_EMP_FK = EMP.ID_EMP_PK AND EXPR.CANTIDAD_EMPACAQUE != 0) AS NUM_BODEGAS "
