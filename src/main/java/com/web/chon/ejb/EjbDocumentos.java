    ...
    public int insertarDocumento(Documento documento) {
        ...
        try {
            Query query = em.createNativeQuery("INSERT INTO  "
                    ...
                    + ",NUMERO_FACTURA,BANCO,LIBRADOR,FECHA_COBRO,ID_FORMA_COBRO_FK,ID_DOCUMENTO_PADRE_FK,ID_TIPO_D,ID_LLAVE) "
                    + " VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
