...
public class BeanVentaMayoreo implements Serializable, BeanSimple {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BeanVentaMayoreo.class);
    ...
    private final BigDecimal PORCENTAJE_RANGO_VENTA = new BigDecimal("0.15");
    ...
    public void habilitarBotones() {
        if (selectedExistencia != null) {
            ...
            JsfUtil.addErrorMessageClean("Selecione un producto.");
        }
