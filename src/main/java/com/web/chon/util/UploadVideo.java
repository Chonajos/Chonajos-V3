...
public class UploadVideo {
    ...
    public double porcentVideoUpload;
    ...
    public static String subir(InputStream inputStream, String nombreVideo) {
        ...
        try {
            ...
            snippet.setTitle(nombreVideo);
            snippet.setDescription("Chonajos " + nombreVideo);

            // Set the keyword tags that you want to associate with the video.
            List<String> tags = new ArrayList<String>();
            tags.add("chonajos");
            tags.add("Central de abastos");
            tags.add(nombreVideo);
