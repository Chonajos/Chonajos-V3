    ...
    public ArrayList<Cliente> getClientes()       
    {
       ...
       try
       {
            ...
            for(Object[] obj: lstObject )
            {
                ...
                cliente.setTel_movil(Integer.parseInt(obj[9].toString()));
                cliente.setTel_fijo(Integer.parseInt(obj[10].toString()));
                cliente.setExt(Integer.parseInt(obj[11].toString()));
                cliente.setEmail(obj[12] == null ? "" : obj[12].toString());
                cliente.setNum_int(Integer.parseInt(obj[13].toString()));
                cliente.setNum_ext(Integer.parseInt(obj[14].toString()));
                ...
                cliente.setColoniaFiscal(obj[22] == null ? "" : obj[22].toString());
                //cliente.setEstadoFiscal(obj[24] == null ? "" : obj[24].toString());
                cliente.setDel_mun_fiscal(Integer.parseInt(obj[23].toString()));
                cliente.setNextel(Integer.parseInt(obj[24].toString()));
                cliente.setRazon_social(obj[25] == null ? "" : obj[25].toString());
                cliente.setRfcFiscal(obj[26] == null ? "" : obj[26].toString());
                cliente.setcpFiscal(Integer.parseInt(obj[27].toString()));
                cliente.setLadaoficina(Integer.parseInt(obj[28].toString()));
    ...
    public Cliente getClienteById(int idCliente) {
       try
       {
            ...
            {    
                ...
                cliente.setTel_fijo(Integer.parseInt(obj[10] == null ? "":obj[10].toString()));
                cliente.setExt(Integer.parseInt(obj[11] == null ? "":obj[11].toString()));
                cliente.setEmail(obj[12] == null ? "":obj[12].toString());
                cliente.setNum_int(Integer.parseInt(obj[13] == null ? "":obj[13].toString()));
                cliente.setNum_ext(Integer.parseInt(obj[14] == null ? "":obj[14].toString()));
                cliente.setColonia(obj[15] == null ? "":obj[15].toString());
                cliente.setClavecelular(Integer.parseInt(obj[16] == null ? "":obj[16].toString()));
                cliente.setLadaoficina(Integer.parseInt(obj[17] == null ? "":obj[17].toString()));
                cliente.setDel_Mun(Integer.parseInt(obj[18].toString()));
                cliente.setCalleFiscal(obj[19] == null ? "":obj[19].toString());
                cliente.setNum_int_fiscal(Integer.parseInt(obj[20] == null ? "":obj[20].toString()));
                cliente.setNum_ext_fiscal(Integer.parseInt(obj[21] == null ? "":obj[21].toString()));
                cliente.setColoniaFiscal(obj[22] == null ? "":obj[22].toString());
                //cliente.setEstadoFiscal(obj[24] == null ? "1":obj[24].toString());
                cliente.setDel_mun_fiscal(Integer.parseInt(obj[23].toString()));
                cliente.setNextel(Integer.parseInt(obj[24] == null ? "":obj[24].toString()));
                cliente.setRazon_social(obj[25] == null ? "":obj[25].toString());
                cliente.setRfcFiscal(obj[26] == null ? "":obj[26].toString());
